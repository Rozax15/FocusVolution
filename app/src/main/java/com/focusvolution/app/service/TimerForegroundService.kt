...
class TimerForegroundService : Service() {
    ...
    private val repository by lazy {
        FocusVolutionRepository(AppDatabase.getDatabase(applicationContext))
    }
    ...
    companion object {
        const val ACTION_CONFIGURE = "com.focusvolution.app.CONFIGURE"
        const val ACTION_START_NEW = "com.focusvolution.app.START_NEW"
        const val ACTION_RESUME = "com.focusvolution.app.RESUME"
        const val ACTION_PAUSE = "com.focusvolution.app.PAUSE"
        const val ACTION_RESET = "com.focusvolution.app.RESET"
