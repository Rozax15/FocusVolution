...
import com.focusvolution.brain_timer.ui.components.BrainCharacter
import com.focusvolution.brain_timer.ui.main.MainUiState
...
fun MainScreen(
    ...
    Column(
        ...
        Text(
            text = "Sessões concluídas: ${uiState.totalSessions}",
            style = MaterialTheme.typography.titleMedium
        )
        Text(
            text = "Nível atual: ${uiState.currentLevel}/10",
            style = MaterialTheme.typography.titleMedium
        )
    }
}
