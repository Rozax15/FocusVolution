...
public final class UserDao_Impl implements UserDao {
  ...
  private final SharedSQLiteStatement __preparedStmtOfMarkEmailVerified;

  private final SharedSQLiteStatement __preparedStmtOfSetVerificationToken;
  ...
  public UserDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUserEntity = new EntityInsertionAdapter<UserEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR ABORT INTO `users` (`id`,`username`,`email`,`passwordHash`,`totalSessions`,`currentLevel`,`isEmailVerified`,`verificationToken`) VALUES (nullif(?, 0),?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        if (entity.getVerificationToken() == null) {
          ...
          statement.bindString(8, entity.getVerificationToken());
        }
      }
    };
    ...
    this.__preparedStmtOfMarkEmailVerified = new SharedSQLiteStatement(__db) {
      @Override
      @NonNull
      public String createQuery() {
        final String _query = "UPDATE users SET isEmailVerified = 1, verificationToken = NULL WHERE id = ?";
        return _query;
      }
    };
    this.__preparedStmtOfSetVerificationToken = new SharedSQLiteStatement(__db) {
      @Override
      @NonNull
      public String createQuery() {
        final String _query = "UPDATE users SET verificationToken = ? WHERE id = ?";
        return _query;
      }
    };
  }
  ...
  @Override
  public Object markEmailVerified(final long id, final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        final SupportSQLiteStatement _stmt = __preparedStmtOfMarkEmailVerified.acquire();
        int _argIndex = 1;
        _stmt.bindLong(_argIndex, id);
        try {
          __db.beginTransaction();
          ...
          __preparedStmtOfMarkEmailVerified.release(_stmt);
        }
      }
    }, $completion);
  }
  ...
  @Override
  public Object setVerificationToken(final long id, final String token,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        final SupportSQLiteStatement _stmt = __preparedStmtOfSetVerificationToken.acquire();
        int _argIndex = 1;
        ...
        try {
          ...
          __preparedStmtOfSetVerificationToken.release(_stmt);
        }
      }
    }, $completion);
  }
      ...
      public UserEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new UserEntity(_tmpId,_tmpUsername,_tmpEmail,_tmpPasswordHash,_tmpTotalSessions,_tmpCurrentLevel,_tmpIsEmailVerified,_tmpVerificationToken);
          } else {
            _result = null;
          }
          return _result;
      ...
      public List<UserEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new UserEntity(_tmpId,_tmpUsername,_tmpEmail,_tmpPasswordHash,_tmpTotalSessions,_tmpCurrentLevel,_tmpIsEmailVerified,_tmpVerificationToken);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Object getUserByVerificationToken(final String token,
      final Continuation<? super UserEntity> $completion) {
    final String _sql = "SELECT * FROM users WHERE verificationToken = ? LIMIT 1";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
