...
public final class BrainTimerDao_Impl implements BrainTimerDao {
  ...
  @Override
  public Flow<AppStateEntity> observeAppState() {
    final String _sql = "SELECT * FROM app_state WHERE id = 0 LIMIT 1";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    return CoroutinesRoom.createFlow(__db, false, new String[] {"app_state"}, new Callable<AppStateEntity>() {
      @Override
      @Nullable
